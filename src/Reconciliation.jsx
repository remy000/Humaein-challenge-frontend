...
function Reconciliation() {
  ...
  const res = await axios.post(`${backendUrl}/reconciliation`, payload);
      if (res.data.error) {
  ...
  return (
    <div>
      <h2 style={{ color: '#1976d2', fontWeight: 700, marginBottom: 24 }}>Reconciliation</h2>
      ...
      {result && (
        <div className="result-card">
          <strong>Reconciliation ID:</strong> {result.id || "N/A"}<br />
          ...
          <strong>Notes:</strong> {result.notes || "N/A"}<br />
